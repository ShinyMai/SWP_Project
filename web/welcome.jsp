            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                <div class="container-fluid">
                    <c:if test ="${sessionScope.acc.role_id == 1}">
                        <a class="navbar-brand" href="academicStaff/home.jsp">Academic Staff</a>
                    </c:if>  
                    <c:if test ="${sessionScope.acc.role_id == 2}">
                        <a class="navbar-brand" href="admin/home.jsp">Admin</a>
                    </c:if>
                    <c:if test ="${sessionScope.acc.role_id == 3}">
                        <a class="navbar-brand" href="instructor/home.jsp">Instructor</a>
                    </c:if>
                    <c:if test ="${sessionScope.acc.role_id == 4}">
                        <a class="navbar-brand" href="student/home.jsp">Student</a>
                    </c:if>
